                                        ...
                                        <div className="flex-grow">
                                            <div className="flex justify-between items-start">
                                                ...
                                                {campaign.paymentStatus === 'verified' ? (
                                                    <span className="px-2.5 py-1 text-xs font-semibold rounded-full bg-green-500/20 text-green-400 flex items-center gap-1.5">
                                                        <Icon name="coin" className="w-4 h-4"/> Payment Verified
                                                    </span>
                                                ) : (
                                                    <span className="px-2.5 py-1 text-xs font-semibold rounded-full bg-yellow-500/20 text-yellow-400 flex items-center gap-1.5">
                                                        Payment Pending
                                                    </span>
                                                )}
                                            </div>
